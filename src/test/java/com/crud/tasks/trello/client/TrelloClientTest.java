...
public class TrelloClientTest {
    ...
    public void init() {
        ...
        when(trelloConfig.getTrelloUsername()).thenReturn(("karolinarakmielcarek"));
    }
    ...
    public void shouldFetchTrelloBoards() throws URISyntaxException {
        ...
        URI uri = new URI("http://test.com/members/karolinarakmielcarek/boards?key=test&token=test&fields=name,id&lists=all");
